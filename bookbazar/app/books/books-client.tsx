          ...
          {!loading && !error && books.length > 0 && (
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {books.map((book) => (
                ...
                >
                 <div className="relative h-64 w-full overflow-hidden bg-linear-to-br from-indigo-100 to-indigo-200 md:h-72">
  {book.imageUrl ? (
    <Image
      src={book.imageUrl}
      alt={book.title}
    ...
    <div className="flex h-full w-full items-center justify-center">
      <span className="text-7xl">📚</span>
                  ...
                  <div className="flex h-full flex-col p-5 md:p-6">
                    <h2 className="line-clamp-2 text-lg font-bold text-slate-900 transition-colors group-hover:text-indigo-600">
                      {book.title}
                    </h2>
                    ...
                    <p className="mt-3 line-clamp-2 grow text-sm text-slate-600">
